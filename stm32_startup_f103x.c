 ...
 * Author: Moez Mefteh
 * Date: 09/06/2023
 * Description: Startup code for the STM32F103C8Tx microcontroller.
 **************************************************************/
...
/*
 * The 'vectors' array defines the Interrupt Vector Table (IVT),
 * which is a list of addresses of exception and interrupt service routines.
 * It is placed in the ".isr_vector" section to specify the startup code's location.
 * The linker script will use this section to properly locate the IVT in memory.
 */
...
/*
 * Default_Handler: Default exception and IRQ handler.
 * This function is called when an exception or unhandled interrupt occurs.
...
/*
 * Reset_Handler: Reset handler and entry point of the application.
 * This function is called on microcontroller startup after initialization.
 * It performs the following tasks:
 * 1. Copies the initialized data section from flash to SRAM.
